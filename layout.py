...
WOUNDPOS = {
    ...
    3: [(CARDWIDTH//2-TOKENEDGE*3//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2+TOKENEDGE*1//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2-TOKENEDGE*1//2, CARDHEIGHT*1//5+TOKENEDGE)],
    4: [(CARDWIDTH//2-TOKENEDGE*3//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2+TOKENEDGE*1//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2-TOKENEDGE*3//2, CARDHEIGHT*1//5+TOKENEDGE),
        (CARDWIDTH//2+TOKENEDGE*1//2, CARDHEIGHT*1//5+TOKENEDGE)],
    5: [(CARDWIDTH//2-TOKENEDGE*3//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2+TOKENEDGE*1//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2-TOKENEDGE*3//2, CARDHEIGHT*1//5+TOKENEDGE),
        (CARDWIDTH//2+TOKENEDGE*1//2, CARDHEIGHT*1//5+TOKENEDGE),
        (CARDWIDTH//2-TOKENEDGE*1//2, CARDHEIGHT*1//5+TOKENEDGE*5//2)],
    6: [(CARDWIDTH//2-TOKENEDGE*3//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2+TOKENEDGE*1//2, CARDHEIGHT*1//5-TOKENEDGE//2),
        (CARDWIDTH//2-TOKENEDGE*1//2, CARDHEIGHT*1//5+TOKENEDGE),
        (CARDWIDTH//2+TOKENEDGE*1//2, CARDHEIGHT*1//5+TOKENEDGE),
        (CARDWIDTH//2-TOKENEDGE*1//2, CARDHEIGHT*1//5+TOKENEDGE*5//2),
